      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 md:grid-cols-2 lg:grid-cols-4 md:px-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-warm-white/80">
            <li>
              <Link href="/tourism" className="hover:text-gold">
                {t("tourismLink")}
              </Link>
            </li>
            <li>
              <Link href="/admin-services" className="hover:text-gold">
                {t("adminLink")}
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-warm-white/80">
            <li>Air Ticketing & Hotels</li>
            <li>Umrah & Holiday Packages</li>
            <li>Employment & Family Visas</li>
            <li>Document Typing & PRO</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="mt-6 flex gap-4">
            <a
              ...
              className="rounded-full bg-whatsapp/20 p-2 text-whatsapp transition hover:bg-whatsapp hover:text-white"
              aria-label="WhatsApp"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full bg-white/10 p-2 transition hover:bg-gold hover:text-navy"
              aria-label="Facebook"
            >
